...
namespace BLL
{
    public class ProdutoBLL : IBLL
    {
        ...
        public List<IEntidade> BuscarPorNomeFornecedor(string _nomeFornecedor)
        {
            throw new NotImplementedException();
        }

        public List<IEntidade> BuscarPorNomeMarca(string _nomeMarca)
        {
            throw new NotImplementedException();
        }
